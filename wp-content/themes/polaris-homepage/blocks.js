...
// Blog Post Content Block
  wp.blocks.registerBlockType('polaris/blog-post-content', {
      ...
      edit: function(props) {
          return wp.element.createElement('div', {
              style: { padding: '20px', border: '2px dashed #ccc',
  textAlign: 'center' }
          }, 'Blog Post Content (displays current post content)');
      },
      save: function() {
          return null;
      }
  ...
  wp.blocks.registerBlockType('polaris/related-articles', {
      ...
      edit: function(props) {
          return wp.element.createElement('div', {
              style: { padding: '20px', border: '2px dashed #ccc',
  textAlign: 'center' }
          }, 'Related Articles (shows 3 related posts automatically)');
      },
      save: function() {
          return null;
      }
